...
const AboutSection: React.FC = () => {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative w-full h-96 rounded-2xl overflow-hidden bg-gradient-secondary flex items-center justify-center">
  ...
  {/* Image */}
  <div className="relative z-10 w-full h-full overflow-hidden rounded-2xl border-4 border-white shadow-xl">
    <img
      src="/image.png"
      alt="Sunal Kumar Saha"
      className="w-full h-full object-cover"
    />
  </div>

  {/* Name Tag - Fixed */}
  <div className="absolute bottom-4 left-2 right-2 z-20 p-4 bg-black/40 text-white rounded-lg backdrop-blur-md border border-white/20 shadow-lg">
